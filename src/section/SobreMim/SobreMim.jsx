...
export function SobreMim(){
    return(
        ...
        <div className={Style.div}>
            ...
            <p>
                Estou disponível e pronto para abraçar novas oportunidades! Sou um desenvolvedor web front-end junior apaixonado por criar experiências incríveis na web. Minhas habilidades incluem o desenvolvimento de planilhas dinâmicas e interativas, bem como a criação de chatbots inteligentes que melhoram a comunicação e a experiência do usuário. Com minha dedicação, curiosidade e vontade de aprender, estou pronto para contribuir em projetos desafiadores que impulsionam a inovação tecnológica. 💪

                Recrutador, permita-me demonstrar meu potencial e paixão pelo desenvolvimento web e juntos construiremos algo incrível! 😉 Espero que isso capte a atenção dos recrutadores e mostre sua motivação e habilidades como desenvolvedor web front-end junior. Se você precisar de mais ajuda, é só me avisar! 🙌
            </p>
        </div>
        </>
    )
